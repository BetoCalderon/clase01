...
public class CrudEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tpMostrar.setBackground(new java.awt.Color(153, 153, 255));
        tpMostrar.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setForeground(new java.awt.Color(0, 102, 102));

        tb_Estudiante.setBackground(new java.awt.Color(153, 153, 255));
        ...
        txtMatricula.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N

        txtIdPersona.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N

        txtUsuario.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N

        txtPass.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N

        txtIdEstudiante.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
        ...
        lblID.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
        lblID.setForeground(new java.awt.Color(0, 51, 51));
        lblID.setText("ID ESTUDIANTE");

        lblNombre.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
        lblNombre.setForeground(new java.awt.Color(0, 51, 51));
        lblNombre.setText("MATRICULA");

        lblApellidos.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
        lblApellidos.setForeground(new java.awt.Color(0, 51, 51));
        lblApellidos.setText("IDPERSONA");

        lblEdad.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
        lblEdad.setForeground(new java.awt.Color(0, 51, 51));
        lblEdad.setText("USUARIO");

        PASS.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
        ...
        lblSexo2.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
        lblSexo2.setForeground(new java.awt.Color(0, 51, 51));
        lblSexo2.setText("NIE");

        txtNIE.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N

        jScrollPane2.setFont(new java.awt.Font("Lucida Bright", 3, 12)); // NOI18N
        ...
        lblID1.setFont(new java.awt.Font("Lucida Bright", 3, 14)); // NOI18N
...
//metodo que guarda los datos de la tabla.
